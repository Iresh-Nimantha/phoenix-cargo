    ...
    >
      <div className="max-w-[1200px] mx-auto grid lg:grid-cols-2 gap-16 lg:gap-20 items-center">
        ...
        <motion.div
          ...
          className="relative bg-ash-800 border border-fire-orange/10 rounded-lg p-14 flex flex-col items-center justify-center min-h-[400px] overflow-hidden"
        >
          {/* Badge pill */}
        ...
        >
          ...
          <h2
            className="font-display font-bold uppercase leading-[1.1] mb-5"
            style={{ fontSize: 'clamp(2rem, 4.5vw, 3rem)' }}
          >
            {content.about.headingLine1}{' '}
            <span className="text-fire-orange">{content.about.headingLine2}</span>
          </h2>
          <p className="text-[15px] text-ash-400 font-light leading-relaxed mb-8">
          ...
          <ul className="flex flex-col gap-4 mb-10">
            {content.about.features.map((feat, i) => (
              <motion.li
                ...
                className="flex items-start gap-3 text-sm font-medium text-ash-200"
              >
